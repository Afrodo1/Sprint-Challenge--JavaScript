...
graduates.forEach(function(object){
  let grads = object.university;
  universities.push(grads);
  universities.sort();
})
...
const lowCaseAnimalNames = zooAnimals.map((object) =>{
...
const lowPopulationAnimals = zooAnimals.filter((object)=>{
...
populationTotal = zooAnimals.reduce((acc, pop) =>{
